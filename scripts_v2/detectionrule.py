...
class DetectionRule:
    ...
    def render_template(self, template_type):
        ...
        if template_type == "markdown":
            template = env.get_template('markdown_detectionrule_template.md.j2')
            ...
            template = env.get_template('confluence_detectionrule_template.html.j2')
            ...
            for output in outputs:
                cmd = "../detectionrules/sigma/tools/sigmac -t "+output+" --ignore-backend-errors "+self.yaml_file
                p = subprocess.Popen(cmd, stdout=subprocess.PIPE, shell=True)
            ...
            for data in data_needed:
                data_needed_id = str(ATCutils.confluence_get_page_id(self.apipath, self.auth, self.space, data))
            ...
            for trigger in technique:
                ...
                try:
                    ...
                    trigger_id = str(ATCutils.confluence_get_page_id(self.apipath, self.auth, self.space, trigger))
